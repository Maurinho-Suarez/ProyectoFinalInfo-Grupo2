...
from .views import CrearPost, ActualizarPost, EliminarPost, ListarPost, CrearCategoria, ActualizarCategoria, EliminarCategoria, detalle_post
...
urlpatterns = [
    ...
    path('post/<int:pk>/', detalle_post, name='post'),
